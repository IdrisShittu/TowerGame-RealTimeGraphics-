...
bool GraphicsRenderer::InitializeSceneObjects(HWND hwnd) {
	if (!InitializeCamera(hwnd) || !InitializeLightManager(hwnd) || !InitializeTerrain(hwnd) ||
...
bool GraphicsRenderer::InitializeLightManager(HWND hwnd) {
...
bool GraphicsRenderer::InitializeTerrain(HWND hwnd) {
...
bool GraphicsRenderer::InitializeGameObjects(HWND hwnd) {
	...
	// Additional GameObjects initialization as necessary
	return true;
}
